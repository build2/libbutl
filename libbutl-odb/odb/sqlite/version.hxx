...
//
#define LIBODB_SQLITE_VERSION_FULL  200004999995281ULL
#define LIBODB_SQLITE_VERSION_STR   "2.5.0-b.28.20240731125623.c6da3d9c4e9f"
#define LIBODB_SQLITE_VERSION_ID    "2.5.0-b.28.c6da3d9c4e9f"
...
#define LIBODB_SQLITE_SNAPSHOT      20240731125623ULL
#define LIBODB_SQLITE_SNAPSHOT_ID   "c6da3d9c4e9f"

#include <odb/version.hxx>

#ifdef LIBODB_VERSION_FULL
#  if !(LIBODB_VERSION_FULL == 200004999995281ULL && LIBODB_SNAPSHOT == 20240731125623ULL)
#    error incompatible libodb version, libodb == 2.5.0-b.28.20240731125623.c6da3d9c4e9f is required
#  endif
#endif
